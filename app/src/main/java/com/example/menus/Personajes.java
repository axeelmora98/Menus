 ...
 * Use the {@link Personajes#newInstance} factory method to
...
public class Personajes extends Fragment {
    ...
    public static Personajes newInstance(String param1, String param2) {
        Personajes fragment = new Personajes();
